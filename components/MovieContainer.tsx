...
const MovieContainer = ({ title, movies, isVertical }: Props) => {
  return (
    <div className="">
      <div className=" w-full py-2 flex items-center justify-between border-b border-b-gray-500 relative mb-4">
      ...
      <div
        className={cn(
          "grid lg:grid-cols-5 md:grid-cols-3 grid-cols-2 gap-4 px-5 lg:px-10 py-5",
